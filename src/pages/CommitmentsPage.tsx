    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="py-8 md:py-10 lg:py-12 space-y-8 animate-in fade-in duration-700">
        ...
        <Tabs defaultValue="weekly" className="w-full">
          ...
          <TabsContent value="my-circle" className="py-6 space-y-8 animate-in fade-in slide-in-from-bottom-2">
            <div className="space-y-4">
          ...
          <TabsContent value="quarterly" className="py-6 space-y-8 animate-in fade-in slide-in-from-bottom-2">
            <div className="p-6 bg-gray-50 text-center border border-dashed border-gray-300">
              <p className="text-xs text-gray-500 italic font-serif">Quarterly summary and deep-dive reflections will aggregate here.</p>
            </div>
          </TabsContent>
        </Tabs>
      </div>
